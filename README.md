...
MuCFF is the reference implementation of Multisource Complementary Feature Fusion for functional DNA sequence classification. It integrates cross-fitted evidence through score alignment, source-preserving anchor-relative residuals, and a joint sparse decision model.
...
The ordered evidence-growth and matched mechanism-ablation tables are
reproduced with:
